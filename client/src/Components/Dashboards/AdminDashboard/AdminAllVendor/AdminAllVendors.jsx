...
const AdminAllVendors = () => {
    ...
    .then(async (result) => {
        if (result.isConfirmed) {
            try {
                await allVendors.delete(`/allUsers/${id}`); // Send DELETE request
            ...
            >
                <div className="modal-box absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                    ...
                    <div className="modal-action flex flex-col gap-4">
                        <Button onClick={() => handleBan('20 Seconds', vendorDet._id) && setIsModalOpen(false)} className="mr-2">20 Seconds</Button>
